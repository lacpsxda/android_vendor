...
echo -e "";
echo -e ${blu}" 〉 5- Release "${txtrst}${red}"     ︱ Only for the official releases by the Team"${txtrst}
echo -e "";
echo -e ${blu}" 〉 6- Milestone "${txtrst}${red}"   ︱ Only for the milestone releases by the Team"${txtrst}
echo -e "";
echo -e ${blu}" 〉 7- Experimental "${txtrst}${red}"︱ Only for the experimental releases by the Team"${xtrst}
echo -e "";
echo -e ${blu}" 〉 8- Final "${txtrst}${red}"       ︱ Only for the final releases by the Team"${xtrst}
echo -e "";
